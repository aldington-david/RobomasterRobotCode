...
int main(void)
{
    uint16_t b;
    frame.header.sof = '$';
    frame.header.data_len = 10;
    frame.data.data1= -0.124f;
    frame.data.data2= 0.1212f;
    frame.data.data3= 42;
    b = get_CRC16_check_sum((uint8_t *) &frame, 12 ,CRC16_INIT);
    printf("%x\r\n", b);
    show_bytes((byte_pointer)&frame, 12);
