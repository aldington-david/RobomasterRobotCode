...
#define VOLUME(x) (((x)*(TIME4_ARR+1)/125)-1) //x=1-100
...
#define L5 ((TIM4_GAIN/392)-1)//低调　so 的频率
...
#define M5 ((TIM4_GAIN/784)-1)//中调　so的频率
...
#define H5 ((TIM4_GAIN/1640)-1)//高调　so的频率
...
extern void buzzer_cali_start(void);
extern void buzzer_cali_success(void);
extern void buzzer_cali_fail(void);
#endif
