...
/**
  ...
  * @retval         返回空
  */
static void chassis_zero_force_control(float32_t *vx_can_set, float32_t *vy_can_set, float32_t *wz_can_set,
...
/**
  ...
  * @retval         返回空
  */
static void chassis_no_move_control(float32_t *vx_set, float32_t *vy_set, float32_t *wz_set,
                                    chassis_move_t *chassis_move_rc_to_vector);

/**
  * @brief          when chassis behaviour mode is CHASSIS_FORWARD_TO_GIMBAL_YAW, chassis control mode is speed control mode.
...
/**
  ...
  * @retval         返回空
  */
static void chassis_forward_to_gimbal_yaw_control(float32_t *vx_set, float32_t *vy_set, float32_t *angle_set,
                                                  chassis_move_t *chassis_move_rc_to_vector);
...
/**
  ...
  * @retval         返回空
  */
static void chassis_follow_gimbal_yaw_control(float32_t *vx_set, float32_t *vy_set, float32_t *angle_set,
                                              chassis_move_t *chassis_move_rc_to_vector);
...
/**
  ...
  * @retval         返回空
  */
static void chassis_no_follow_yaw_control(float32_t *vx_set, float32_t *vy_set, float32_t *wz_set,
                                          chassis_move_t *chassis_move_rc_to_vector);

static void chassis_spin_control(float32_t *vx_set, float32_t *vy_set, float32_t *angle_set,
                                 chassis_move_t *chassis_move_rc_to_vector);
...
static void chassis_open_set_control(float32_t *vx_set, float32_t *vy_set, float32_t *wz_set,
                                     chassis_move_t *chassis_move_rc_to_vector);
...
//          chassis_behaviour_mode = CHASSIS_FORWARD_TO_GIMBAL_YAW;
    ...
    } else if (chassis_behaviour_mode == CHASSIS_FORWARD_TO_GIMBAL_YAW) {
        chassis_move_mode->chassis_mode = CHASSIS_VECTOR_TO_GIMBAL_YAW;
    } else if (chassis_behaviour_mode == CHASSIS_FORWARD_FOLLOW_GIMBAL_YAW) {
...
void chassis_behaviour_control_set(float32_t *vx_set, float32_t *vy_set, float32_t *angle_set,
                                   chassis_move_t *chassis_move_rc_to_vector) {
    ...
    if (chassis_behaviour_mode == CHASSIS_ZERO_FORCE) {
        ...
        chassis_forward_to_gimbal_yaw_control(vx_set, vy_set, angle_set, chassis_move_rc_to_vector);
    } else if (chassis_behaviour_mode == CHASSIS_FORWARD_FOLLOW_GIMBAL_YAW) {
...
static void chassis_follow_gimbal_yaw_control(float32_t *vx_set, float32_t *vy_set, float32_t *angle_set,
    ...
    *angle_set = chassis_move.chassis_yaw;
}
...
static void chassis_open_set_control(float32_t *vx_set, float32_t *vy_set, float32_t *wz_set,
    ...
    *wz_set = -chassis_move_rc_to_vector->chassis_RC->rc.ch[CHASSIS_YAW_CHANNEL] * CHASSIS_OPEN_RC_SCALE;
    return;
}
